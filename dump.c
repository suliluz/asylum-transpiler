...
int main(int argc, char** argv) {
    ...
    ptr -= 4; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 3; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 4; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 4; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 4; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 5; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 4; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 5; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 5; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    ...
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 3; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ptr += 5; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 2; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 1033; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1031; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1033; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 1033; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1033; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1034; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1033; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1034; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1034; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1035; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1034; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1035; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1035; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1036; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1035; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1036; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1036; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1037; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1036; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1037; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1037; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 8; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 7; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 8; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 8; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 8; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1040; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1039; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1040; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 1040; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1040; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 6; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 8; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 1044; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1042; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1044; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 1044; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1044; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 7; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 5; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    ptr -= 9; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ptr += 9; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    }
    }
    ...
    ptr -= 13; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 11; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 13; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 13; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 13; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1048; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1046; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 2; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1048; if (ptr < tape) ptr += TAPE_SIZE;
    }
    ptr += 1048; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1048; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 11; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 9; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    ptr -= 15; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ptr += 15; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    }
    }
    ...
    ptr -= 10; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 9; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 10; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 10; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1045; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1044; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1045; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1045; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1047; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1045; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1047; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1047; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1041; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 4; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1045; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 6; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 4; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1042; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1043; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1042; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 1049; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1048; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1049; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1049; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 12; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 8; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 12; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 12; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1031; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1030; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 1031; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 1032; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1031; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1032; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1032; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1038; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1037; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1038; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1038; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1041; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1040; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 14; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr += 1; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ptr -= 15; if (ptr < tape) ptr += TAPE_SIZE;
    ...
    ptr -= 2; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    ptr -= 16; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
    ptr += 16; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    }
    }
    ...
    ptr -= 14; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 10; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr -= 1050; if (ptr < tape) ptr += TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr += 1049; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    (*ptr) += 1;
    ...
    ptr += 1050; if (ptr >= tape + TAPE_SIZE) ptr -= TAPE_SIZE;
    while (*ptr) {
    (*ptr) -= 1;
    ptr -= 1050; if (ptr < tape) ptr += TAPE_SIZE;
    (*ptr) += 1;
