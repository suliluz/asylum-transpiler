...
void compile_bf_to_c(const char* bf_code, FILE* out) {
    ...
    fprintf(out, "    tape[0] = (unsigned char)argc;\n");
    fprintf(out, "    time_t t = time(NULL);\n");
    fprintf(out, "    struct tm tm = *localtime(&t);\n");
    fprintf(out, "    tape[1] = (unsigned char)((tm.tm_year + 1900) %% 100);\n");
    fprintf(out, "    tape[2] = (unsigned char)(tm.tm_mon + 1);\n");
    fprintf(out, "    tape[3] = (unsigned char)tm.tm_mday;\n");
    fprintf(out, "    tape[4] = (unsigned char)tm.tm_hour;\n");
    fprintf(out, "    tape[5] = (unsigned char)tm.tm_min;\n");
    fprintf(out, "    tape[6] = (unsigned char)tm.tm_sec;\n");
    fprintf(out, "    int offset = 7;\n");
